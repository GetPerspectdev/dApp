      ...
      <CardContent>
        ...
        <div className="mt-2 flex flex-col items-center justify-between gap-2 sm:flex-row">
          <div className="flex max-w-full flex-wrap items-center gap-2">
            ...
            >
              <span className="flex size-7 cursor-pointer items-center justify-center rounded-md bg-neutral-100 p-2 hover:bg-neutral-200 dark:bg-neutral-800 hover:dark:bg-neutral-900">
            ...
            <div className="mb-5 mt-2 flex items-center">
              ...
              <div className="ml-2 flex-col">
                ...
                <div className="flex items-center font-mono text-xs">
                  ...
                  >
                    <span className="ml-2 flex size-7 cursor-pointer items-center justify-center rounded-md bg-neutral-100 p-2 hover:bg-neutral-200 dark:bg-neutral-800 hover:dark:bg-neutral-900">
                      <FaCopy className="text-muted-foreground" />
                    </span>
                  </CopyToClipboard>
                </div>
