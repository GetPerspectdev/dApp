...
export default function MintPage() {
  return (
    <section className="p-8">
      ...
      <Tabs className="w-full max-w-xl" defaultValue="erc20">
        ...
        <TabsContent value="erc20">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ERC-20 is the base standard for minting fungible tokens which
        ...
        <TabsContent value="erc721">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ERC-721 token standard enables minting non-fungible tokens
                (NFT), which are unique and not interchangeable.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              <div className="space-y-1">
